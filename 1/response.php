<?php
    ...
    $hasil['nextPageToken'] = $result['nextPageToken'];
    $hasil['data'] = 'https://www.googleapis.com/youtube/v3/commentThreads?part=snippet&videoId='.$videoId.'&key=AIzaSyCIbp9uGZhPTc2yC0z1bSltADLgm7IT_Ds&maxResults=20&textFormat=plainText&pageToken='.$hasil['nextPageToken'];
    // var_dump($hasil);
